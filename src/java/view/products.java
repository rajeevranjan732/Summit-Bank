 ...
 * products.java
 *
 * Created on June 12, 2013, 12:16 PM
 */
...
public class products extends HttpServlet {
    ...
    throws ServletException, IOException 
    {
        ...
        String obj=request.getParameter("action"); 
	              ...
	              String Code=request.getParameter("Plist");
	...
	if(obj.equals("Add"))
	    
              {
               ...
               try
		        ...
		        PreparedStatement stat=con.prepareStatement("insert into productDetails values(?,?,?)");
		...
		try
                   ...
                   {    Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
                        con=DriverManager.getConnection("jdbc:odbc:Banking","sa","aparnaap");
			PreparedStatement stat=con.prepareStatement("update productDetails set  ProductName=?,ProductDescription=? where ProductCode=?");
	...
	if(obj.equals("Delete"))
		    ...
		    {   Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
                        con=DriverManager.getConnection("jdbc:odbc:Banking","sa","aparnaap");
			PreparedStatement stat=con.prepareStatement("delete from productDetails where ProductCode=?");
			stat.setString(1,Code);
			rows=stat.executeUpdate();
		    }
		catch(Exception e3)
