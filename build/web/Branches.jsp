...
<!-- content begins -->
 <div id="main">
	<div id="right">
		<div class="box">
			 <div class="box2">
			<h4><a href="#">Branch Details</a></h4><br />
			
                         <form action="Branches.view" method="post">
     <fieldset>
...
<textarea rows="5" cols="52" name="blocation">
